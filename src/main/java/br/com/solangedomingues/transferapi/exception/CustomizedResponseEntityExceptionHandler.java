...
import br.com.solangedomingues.transferapi.dto.SituationDTO;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ResponseDTO> handleUserNotFoundException(NotFoundException ex, WebRequest request) {

        return new ResponseEntity<>(new ResponseDTO(new SituationDTO(HttpStatus.NOT_FOUND.value(), ex.getMessage(),
    ...
    protected ResponseEntity<Object> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex, WebRequest request) {
        return new ResponseEntity<>(new ResponseDTO(new SituationDTO(HttpStatus.BAD_REQUEST.value(), ex.getMessage(),
    ...
    protected ResponseEntity<Object> handleNegativeBalanceException(NegativeBalanceException ex, WebRequest request) {
        return new ResponseEntity<>(new ResponseDTO(new SituationDTO(HttpStatus.UNPROCESSABLE_ENTITY.value(), ex.getMessage(),
